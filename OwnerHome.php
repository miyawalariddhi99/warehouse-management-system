...
<html lang="en">
    <head>
        ...
        <title>Warehouse Owner Panel</title>
        ...
        <form method="post">
            <header>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark">
                    <div class="container">
                        <a class="navbar-brand" href="#">WareSync</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav ms-auto">
                                <li class="nav-item">
                                    <a class="nav-link" aria-current="page" href="OwnerHome.php">Home</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="ViewCity.php">Warehouses</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="ViewStaff.php">Staff</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="Addwarehouse.php">ADD Warehouse</a>
                                </li>
            ...
            <div class="main-content">
                <div class="header">
                    <h1>Welcome to the Owner's Panel</h1>
                    <?php
                    $con = mysqli_connect("localhost:3307","root","","warehouse");
                    $id = "select * from tblowner where EMAIL = '$input_username'";
                    ...
                    $Ownername = $r[1];
                    ?>
                    <p><?php echo "Welcome $Ownername Your ID is :  $ownerid";?>!</p>
                </div>
                <div class="dashboard-cards">
                    <div class="card green">
                        <?php
                        $con = mysqli_connect('localhost:3307', 'root', '', 'warehouse');
                        $b_c = "select count(*) from tblwarehousereg where OwnerID = $ownerid";
                        $b_q = mysqli_query($con, $b_c);
                        $r = mysqli_fetch_row($b_q);
                        $count = $r[0];
                        ?>
                        <h3><?php echo "$count"; ?></h3>
                        <p>Your Total Warehouses</p>
                        <a href="OwnerPartWarehouse.php">View Warehouses</a>
                    </div>
                    <div class="card red">
                        <?php
                        $o_c = "select count(*) from tblbooking";
                        $o_q = mysqli_query($con, $o_c);
                        $ro = mysqli_fetch_row($o_q);
                        $count_o = $ro[0];
                        ?>
                        <h3><?php echo "$count_o"; ?></h3>
                        <p>Bookings Request</p>
                        <a href="BookingOwner.php">Bookings</a>
                    </div>
                    <div class="card orange">
                        <?php
                        $staff = "select count(*) from staff";
                        
                        $staffq = mysqli_query($con, $staff);
                        $re = mysqli_fetch_row($staffq);
                    ...
                    <div class="card blue">
                        <h3>10</h3>
                        <p>Payments</p>
                        <a href="#">View Payment Info</a>
                    </div>
                    <!--                    <div class="low-stock">
                                            <h2>Low Stock Goods:</h2>
                                            <p>Item 01 has only 1 Stock Left.</p>
                                        </div>-->
                </div>
        </form>
    </body>

...
//    
    ...
    if ($_SESSION['otp'] == $otp1) {
        $hash = md5($rrepass);
            $query = "insert into tblcustomer(FNAME,LNAME,GENDER,ADDRESS,CityID,PHNO,EMAIL,PASSWORD,IDProof) values ('$rfname','$rlname','$rgender','$radd',$rcity,$rphone,'$remail','$hash','$rIDProof')";

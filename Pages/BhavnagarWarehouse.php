...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h1>Warehouse Data for Bharuch</h1>
            ...
            if (!$con) {
                ...
                $bhavnagar = "SELECT * FROM tblwarehousereg WHERE CityID = 7 AND Verification='APPROVE' AND Availability='AVAILABLE'";
                $q_bhavnagar = mysqli_query($con, $bhavnagar);
                if ($q_bhavnagar) {
                    echo "<table border=1>";
                    echo "<tr>";
                    echo "<th>ID</th>";
                    ...
                    while ($r = mysqli_fetch_assoc($q_bhavnagar)) {
                    ...
                    <img src="images/' . $r["image2"] . '" width="100" height="100" alt="Warehouse Image 2">
                    <img src="images/' . $r["image3"] . '" width="100" height="100" alt="Warehouse Image 3">
                  </td>';
                        echo '<td>' . $r["RENT"] . '</td>';
                        echo '<td>' . $r["SIZE"] . '</td>';
        ...
        <!-- Footer 
        <div class="footer">
            <p>&copy; 2024 Store Smart. All rights reserved.</p>
        </div>-->

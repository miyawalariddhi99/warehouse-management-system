...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h1>Warehouse Data for Amreli</h1>
            <?php
            ...
            if (!$con) {
                ...
                $amreli = "SELECT * FROM tblwarehousereg WHERE CityID = 4 AND Verification='APPROVE' AND Availability='AVAILABLE'";
                $q_amreli = mysqli_query($con, $amreli);
                if ($q_amreli) {
                    echo "<table border=1>";
                    echo "<tr>";
                    echo "<th>ID</th>";
                    ...
                    while ($r = mysqli_fetch_assoc($q_amreli)) {

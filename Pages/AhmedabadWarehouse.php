...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h1>Warehouse Data for Ahmedabad</h1>
            <?php
            ...
            if (!$con) {
                ...
                $ahmedabad = "SELECT * FROM tblwarehousereg WHERE CityID = 2 AND Verification='APPROVE' AND Availability='AVAILABLE'";
                $q_ahmedabad = mysqli_query($con, $ahmedabad);
                if ($q_ahmedabad) {
                    echo "<table border=1>";
                    echo "<tr>";
                    echo "<th>ID</th>";
                    ...
                    while ($r = mysqli_fetch_assoc($q_ahmedabad)) {

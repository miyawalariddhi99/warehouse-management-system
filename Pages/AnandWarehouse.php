...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h1>Warehouse Data for Anand</h1>
            ...
            if (!$con) {
                ...
                $anand = "SELECT * FROM tblwarehousereg WHERE CityID = 5 AND Verification='APPROVE' AND Availability='AVAILABLE'";
                $q_anand = mysqli_query($con, $anand);
                if ($q_anand) {
                    echo "<table border=1>";
                    echo "<tr>";
                    echo "<th>ID</th>";
                    ...
                    while ($r = mysqli_fetch_assoc($q_anand)) {

...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h1>Warehouse Data for Navsari</h1>
            <?php
            ...
            if (!$con) {
                ...
                $navsari = "SELECT * FROM tblwarehousereg WHERE CityID = 8 AND Verification='APPROVE' AND Availability='AVAILABLE'";
                $q_navsari = mysqli_query($con, $navsari);
                if ($q_navsari) {
                    echo "<table border=1>";
                    echo "<tr>";
                    echo "<th>ID</th>";
                    ...
                    while ($r = mysqli_fetch_assoc($q_navsari)) {

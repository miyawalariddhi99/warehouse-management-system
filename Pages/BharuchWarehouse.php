...
<div class="container">
    ...
    if (!$con) {
        ...
        $bharuch = "SELECT * FROM tblwarehousereg WHERE CityID = 16 AND Verification='APPROVE' AND Availability='AVAILABLE'";
        $q_bharuch = mysqli_query($con, $bharuch);
        if ($q_bharuch) {
            echo "<table>";
            echo "<tr>";
            echo "<th>ID</th>";
            ...
            while ($r = mysqli_fetch_assoc($q_bharuch)) {

...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h1>Warehouse Data for Rajkot</h1>
            ...
            if (!$con) {
                ...
                $rajkot = "SELECT * FROM tblwarehousereg WHERE CityID = 3 AND Verification='APPROVE' AND Availability='AVAILABLE'";
                $q_rajkot = mysqli_query($con, $rajkot);
                if ($q_rajkot) {
                    echo "<table border=1>";
                    echo "<tr>";
                    echo "<th>ID</th>";
                    ...
                    while ($r = mysqli_fetch_assoc($q_rajkot)) {

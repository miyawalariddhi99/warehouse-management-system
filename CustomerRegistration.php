    ...
    if ($_SESSION['pass'] == $_SESSION['repass']) {
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            if (mail($email, $subject, $message, $headers)) {
                header("Location: CustomerOTPpopup.php");
                exit();
            }
        }
...
mysqli_close($con);
unset($_SESSION['fname'],$_SESSION['lname'],$_SESSION['gender'],$_SESSION['add'],$_SESSION['city'],$_SESSION['phone'],$_SESSION['email'],$_SESSION['pass'],$_SESSION['repass'],$_SESSION['IDProof']);
?>
